...
function SparklinePeity() {
    ...
    params.lineColor = '#ffba56';
    params.fillColor = '#ffba56';
    $('#demo-sparkline-line2').sparkline('html', params);
    params.lineColor = '#289cf5';
    params.fillColor = '#84c0ec';
    $('#demo-sparkline-line3').sparkline('html', params);
    params.lineColor = '#82968d';
    params.fillColor = '#91ada1';
    $('#demo-sparkline-line4').sparkline('html', params);
    params.lineColor = '#774421';
    params.fillColor = '#2bcbba';
    ...
    paramsBar.barColor = '#fff';
    $('.mini-bar-chart6').sparkline(values2[5], paramsBar);
